...
export default function FarmerDash() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.log("soildataresponse", soilDataResponse);
        ...
        // Fetch orders data after getting store data
        const ordersResponse = await axios.get(
          `${apiUrl}/orders/${farmerIdNo}`
        );
        // Handle successful response
  ...
  const getImageSource = (fertilizerName) => {
    switch (fertilizerName) {
      ...
      default:
        return "/fertilizerimages/default.jpg";
    }
  };
  return (
    <>
                      ...
                      <li>
                        <a
                          ...
                          onClick={(e) => {
                            ...
                            handleRecommendationsClick(); // Call your scroll function
                          }}
                        >
                          <svg
                            class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                      ...
                      <ul role="list" className="divide-y divide-gray-200">
                        <li className="py-3 sm:py-4">
                          <div className="flex items-center space-x-4">
                            ...
                            <p className="flex-shrink-0 text-base font-semibold text-gray-900">
                              Fertilizer Image
                            </p>
                            {/* Title: Name */}
                            <p className="flex-1 min-w-0 text-base font-semibold text-gray-900">
                              Name
                            </p>
                            {/* Title: Quantity */}
                            <p className="inline-flex flex-col items-center text-base font-semibold text-gray-900">
                              Quantity
                            </p>
                            {/* Title: Price */}
                            <p className="inline-flex flex-col items-center text-base font-semibold text-gray-900">
